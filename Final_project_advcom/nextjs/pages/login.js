...
export default function AuthPage() {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      history.push('/menu'); // Redirect to menu page
    } catch (error) {
  ...
  return (
    <Grid container spacing={2} style={{ height: '100vh', justifyContent: 'center', alignItems: 'center' }}>
          ...
          <form onSubmit={handleLoginSubmit}>
            ...
            <Box display="flex" alignItems="center" justifyContent="space-between" mt={2}>
              ...
              <Box display="flex" alignItems="center">
                ...
                <Button variant="contained" color="secondary" onClick={() => history.push('#register-section')}>
                  Register
                </Button>
              </Box>
            </Box>
      ...
      {/* Register Section */}
      <Grid item xs={12} sm={6} id="register-section">
        <Paper elevation={3} style={{ padding: '20px' }}>
          <Typography variant="h5" gutterBottom>
            Register
          </Typography>
